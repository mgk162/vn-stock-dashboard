...
with st.sidebar:
    ...
    data_source = st.selectbox("Nguồn dữ liệu", ["AUTO", "VCI", "DNSE"], index=0)
...
with overview_tab:
    ...
    if not st.session_state.beginner_mode:
        ...
        fmt_dict = {
            ...
            f"Beta vs {benchmark}": "{:.3f}", "Alpha (năm)": "{:.2%}",
...
with verdict_tab:
    ...
    for col in asset_cols:
        ...
        beta_v = metrics_df.loc[col, f"Beta vs {benchmark}"]
